"""Single Alpha: Skew -- Pure inverted rolling skewness (256-day)"""
import sys
import numpy as np
import pandas as pd
...
STRATEGY_NAME = "Single_Alpha_Skew"
OOS_START = 1280
...
def run_strategy():
    ...
    for instrument in tqdm(mapping.index, desc=STRATEGY_NAME):
        ...
        # -- SIGNAL: Inverted 256-day rolling skewness --
        raw = -price_changes.rolling(256, min_periods=128).skew().fillna(0.0)
