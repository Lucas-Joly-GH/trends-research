"""Single Alpha: EWMAC_Slow -- Pure slow trend (128/512)"""
import sys
import numpy as np
import pandas as pd
...
STRATEGY_NAME = "Single_Alpha_EWMAC_Slow"
OOS_START = 1280
...
def run_strategy():
    ...
    for instrument in tqdm(mapping.index, desc=STRATEGY_NAME):
        ...
        # -- SIGNAL: EWMAC 128/512 --
        raw = compute_ewmac_raw(close, vol, 128, 512)
        forecast_scaled = cap_forecast(raw.fillna(0.0) * rolling_forecast_scalar(raw.fillna(0.0)))
