"""Single Alpha: Acceleration -- Rate of change of EWMAC (trend acceleration)"""
import sys
import numpy as np
import pandas as pd
...
STRATEGY_NAME = "Single_Alpha_Acceleration"
OOS_START = 1280
...
def run_strategy():
    ...
    for instrument in tqdm(mapping.index, desc=STRATEGY_NAME):
        ...
        # -- SIGNAL: diff(EWMAC_64_256, periods=63) --
        ewmac = compute_ewmac_raw(close, vol, 64, 256)
        raw = ewmac.diff(63).fillna(0.0)
