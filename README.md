...
| [`production/`](production/) | A lean reimplementation of the S183 signal and portfolio path for daily paper trading — four dependencies, no pandas, with a differential test suite that verifies each stage against the thesis implementation. |
